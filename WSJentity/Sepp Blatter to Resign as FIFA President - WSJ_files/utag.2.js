//tealium universal tag - utag.2 ut4.0.201505111859, Copyright 2015 Tealium.com Inc. All Rights Reserved.
var s_account="djglobal,djwsj";var s=s_gi(s_account);s.dynamicAccountSelection=true;s.dynamicAccountList="djglobal,djbarrons=barrons.com;djglobal,djjapanwsj=jp.wsj.com,jp.s.dev.wsj.com;djglobal,djwsjturkey=wsj.com.tr;djdowjdev=s.dev.wsj.com;djglobal,djwsjgermany=www.wsj.de;djglobal,djwsj=wsj.com;";s.trackDownloadLinks=false;s.trackExternalLinks=false;s.trackInlineStats=true;s.linkDownloadFileTypes="zip,exe,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx";s.linkInternalFilters="javascript:,wsj.com,wallstreetjournal.com,bankrate.com,cj.careers.adicio.com,wallstreetjournal.stats.com,traffic.outbrain.com";s.linkLeaveQueryString=false;s.linkTrackVars="None";s.linkTrackEvents="None";s.usePlugins=false;s.currencyCode="USD";s.visitorNamespace="dowjones";s.trackingServer="om.dowjoneson.com";s.trackingServerSecure="oms.dowjoneson.com";s.dc=122;var s_code='',s_objectID;function s_gi(un,pg,ss){var c="s.version='H.24.4';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(m,\"\\n\",\"\\\\n\"),\""
...
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1,'link':1,'video':1};u.o=s;u.pushlt=function(l,v){if(typeof l!="undefined")l.push(v)};u.map={"qp.reflink":"prop11","baseURL":"prop5","qp.refresh":"prop7","page_prop4":"prop4,eVar39,eVar40","fullURL":"prop6","meta.page.id":"prop20","Edition":"prop24","page_prop2":"prop2,eVar25,eVar54,","page_prop3":"prop3,eVar37","link_or_mod":"prop10,campaign,eVar5","article_author":"prop21,eVar61","cp.TR":"prop25,eVar3","pageName":"pageName,eVar4","channel":"channel,eVar11","page_prop22":"prop22","server":"server","page_content_type":"prop19,eVar38,eVar53","qp.term":"prop18","page_prop9":"prop9","event_name:Home":"event12,event17","event_name:Summaries":"event12,event16","event_name:Article":"event12,event18","event_name:Blogs":"event12,event68","event_name:Multimedia":"event12,event54","event_name:SaveClick":"event93","event_name:ShareTool":"event89","event_name:FeaturedVideoClick":"event36","event_name:EmailClick":"event12","event_name:Commenting":"event82","google_fcf:GoogleFCF":"event75","google_fcf:MW_BarronsFCF":"event75","meta.page.section":"prop1,eVar52","page_prop53":"prop53","page_eVar59":"eVar59","page_prop13":"prop13","page_prop27":"prop27,eVar26","meta.article.template:snippet":"event69","ad_var":"eVar56","page_prop23":"prop23","cp.utag_main_v_id":"prop66,eVar65","page_prop68":"prop68","meta.article.page":"prop26,eVar29,eVar55","cp.cke":"prop70"};u.extend=[function(a,b){s.getPageName=new Function("u",""
...
+"g(x+1)}return n");s.getVisitNum=new Function("tp","c","c2",""
...
+"t;");s.getDaysBeforeEvent=new Function(""
...
+"ay';}}else return '';}}");s.getFullReferringDomains=new Function(""
+"var s=this,dr=document.referrer,n=s.linkInternalFilters.spli"
+"t(',');if(dr){var r=dr.split('/')[2],l=n.length;for(i=0;i<=l;i++){i"
+"f(r.indexOf(n[i])!=-1){r='';i=l+1;}}return r}");s.eVar62=s.getFullReferringDomains();s.getPreviousValue=new Function("v","c","el",""
...
+"++]=l.substring(0,i);l=l.substring(i+d.length);}return a");s.charSet="ISO-8859-1";s.trackExternalLinks=false;s.vmk="44BD02B1";var dt=new Date();this.weekday=[];this.weekday[0]="Sunday";this.weekday[1]="Monday";this.weekday[2]="Tuesday";this.weekday[3]="Wednesday";this.weekday[4]="Thursday";this.weekday[5]="Friday";this.weekday[6]="Saturday";s.eVar31=this.weekday[dt.getDay()];s.eVar32=dt.getHours()+":00";},function(a,b){s.prop8=utag.data['page_prop8']
var classes=$('body').attr('class'),classArr=classes.split(' '),str='units',i=0,gridSize;for(i;i<classArr.length;i+=1){if(classArr[i].lastIndexOf(str)!==-1){gridSize=classArr[i];utag.data['viewMode']=gridSize;s.prop8=s.prop8+"_"+utag.data['viewMode'];break;}};},function(a,b){if(a=="view"){s.prop65=s.getPreviousValue(b["pageName"],'gpv_pn');}}];u.send=function(a,b,c,d,e,f,g,h,ev,evt){if(u.ev[a]||typeof u.ev.all!="undefined"){utag.DB("send:2");b.sc_events=b.sc_events||{};u.addEvent=function(v){var t=[];if(v instanceof Array){t=v.slice(0);}else{t.push(v);}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('2','wsjdn.wsjarticles');}catch(e){};